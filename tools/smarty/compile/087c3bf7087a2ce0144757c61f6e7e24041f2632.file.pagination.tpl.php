<?php /* Smarty version Smarty-3.0.7, created on 2011-10-19 10:20:54
         compiled from "/home/goforfu1/public_html/yourkwiksave.com/themes/yourkwiksavev2/./pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1641343174e9e8866578c27-06398438%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '087c3bf7087a2ce0144757c61f6e7e24041f2632' => 
    array (
      0 => '/home/goforfu1/public_html/yourkwiksave.com/themes/yourkwiksavev2/./pagination.tpl',
      1 => 1315907213,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1641343174e9e8866578c27-06398438',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('start')->value!=$_smarty_tpl->getVariable('stop')->value){?>
	...
	<div id="pagination" class="pagination">
		...
		<?php if ($_smarty_tpl->getVariable('p')->value!=1){?>
			...
			<li id="pagination_previous"><a class="button_small" href="<?php echo $_smarty_tpl->getVariable('link')->value->goPage($_smarty_tpl->getVariable('requestPage')->value,$_smarty_tpl->getVariable('p_previous')->value);?>
"><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
			<li id="pagination_previous" class="disabled"><span class="button_small"><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span></li>
		<?php }?>
...
"><?php echo intval($_smarty_tpl->getVariable('pages_nb')->value);?>
		...
		<?php if ($_smarty_tpl->getVariable('pages_nb')->value>1&&$_smarty_tpl->getVariable('p')->value!=$_smarty_tpl->getVariable('pages_nb')->value){?>
			...
			<li id="pagination_next"><a class="button_small" href="<?php echo $_smarty_tpl->getVariable('link')->value->goPage($_smarty_tpl->getVariable('requestPage')->value,$_smarty_tpl->getVariable('p_next')->value);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
			<li id="pagination_next" class="disabled"><span class="button_small"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</span></li>
		<?php }?>
		</ul>
...
" /><?php }?>
			<a href="javascript:document.getElementById('pagination_form').submit();"><?php echo smartyTranslate(array('s'=>'Ok'),$_smarty_tpl);?>
</a>
