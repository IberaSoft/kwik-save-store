...
<div class="block block_dark myaccount">
	...
	<div class="block_content">
		...
		<p class="logout">
			<a class="button" href="{$base_dir}index.php?mylogout" title="{l s='log out' mod='blockmyaccount'}">{l s='Sign out' mod='blockmyaccount'}</a>
		</p>
	</div>
</div>
<!-- /Block myaccount module -->
